...
////			if (externos.isEmpty()) {
////				System.out.println("------------------------");
////				System.out.println("Lista de Externos vacia");
...
////
////				addUsuario(1, "root", "Administrador Informatica", "infoimps",
////						1, "noreply@admin.com", 1, new Date(), rol);
////			} else {
//
////				System.out.println("------------------------");
////				System.out.println("Lista de Externos LLENA");
////				// insertar todos.
...
//	// }
//
//	public Usuario addUsuario(final int id, final String nick,
